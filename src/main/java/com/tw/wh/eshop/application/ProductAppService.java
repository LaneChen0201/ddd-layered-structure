...
public class ProductAppService {
    ...
    public String createProduct(CreateProductCommand command) {
        Product product = ProductFactory.create(command.getName(), command.getDescription(), command.getPrice());
    ...
    public ProductPTO byId(String id) {
        ...
        return new ProductPTO(product.getId(), product.getName(), product.getDescription(), product.getPrice());
    }
}
